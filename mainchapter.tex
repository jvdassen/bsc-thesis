...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{screenshots/Home.png}
\caption{\label{fig:ui-}Requesting, building, signing and submitting payment information with the Bazo Wallet.}
\end{figure}
