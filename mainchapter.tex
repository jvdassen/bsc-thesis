...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{diagrams/ripplelibSendTX.png}
\caption{\label{fig:ripplesendTx} Programmatically creating, signing and sending a transaction with Ripple-lib \citep{ripplelib}.
\end{figure}.
