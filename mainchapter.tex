...
This page can also be opened with an address supplied in the URI, which would then be filled into the form. This is employed to make the process of inviting the user into the system easier. Figure \ref{fig:uiaccounts} gives an insight on how this Page is being displayed if there is an unconfirmed and a confirmed account.
